...
from InceptionVAE_trainer import InceptionVAE_trainer
import plot_graph
...
if __name__ == '__main__':
    ...
    # parser.add_argument("--Inception-outsize", type=int)
    ...
    out_dir = './result-InceptionVAE_single' 

    if args.id != '':
        out_dir += '/' + args.id

    out_dir += '/first_channel_{}'.format(args.first_channel)
